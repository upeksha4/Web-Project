            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href="#"><i class="fa fa-file-image-o fa-fw"></i> Recived Jobs<span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="#">Albums</a>
                                </li>
                                <li>
                                    <a href="#">Thanks Card</a>
                                </li>
                                 <li>
                                    <a href="#">Re-touching</a>
                                </li>                                
                            </ul>
                            <!-- /.nav-second-level -->
                        </li>
                        ...
                        <li>
                            <a href="forms.php"><i class="fa fa-paypal"></i> Payments</a>
                        </li>
                        <li>
                        ...
                        <li>
                            <a href="#"><i class="fa fa-files-o fa-fw"></i> Pages Summary <span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
                                <li>
...
include 'include/connect.php';
 ...
 # Prepare the SELECT Query
  $selectSQL = "SELECT * FROM add_port";
