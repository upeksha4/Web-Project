    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">Album Details </h1>
                        <div class="col-lg-4">
                            <select name="filter" class="form-control" onChange="filter(this.value)">
                            <option>--Select Filter type-- </option>
                            <option value="alb_type"> Album Type </option>
                            <option value="alb_bind"> Bind Method </option>
                            </select>             
                        </div><br>           
                    </div>
                    <!-- /.col-lg-12 -->					
    ...
    <?php
      if( mysql_num_rows( $selectRes )==0 ){
        ...
        while( $row = mysql_fetch_assoc( $selectRes ) ){
          echo "<tr><td>{$row['alb_type']}</td><td>{$row['alb_size']}</td><td>{$row['alb_bind']}</td>
		  <td>{$row['alb_des']}</td><td>{$row['sub_date']}</td></tr>\n";
        }
      }
    ?>
  </tbody>
