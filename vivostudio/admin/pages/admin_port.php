    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">Re-touch Portraits Details </h1>
                        <div class="col-lg-4">
    ...
    <?php
      if( mysql_num_rows( $selectRes )==0 ){
        ...
        while( $row = mysql_fetch_assoc( $selectRes ) ){
          echo "<tr><td>{$row['sub_date']}</td><td>{$row['port_type']}</td><td>{$row['port_size']}</td>
          <td>{$row['frm_type']}</td><td>{$row['port_ch_bg']}</td><td>{$row['port_des']}</td><td>{$row['total']}</td></tr>\n";
        }
      }
    ?>
  </tbody>
